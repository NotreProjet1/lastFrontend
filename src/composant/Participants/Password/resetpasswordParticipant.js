...
import Apinner from "../Password/spinner";
import Alert from "../Password/alert";
    ...
    const handleEmailSubmit = async (values, { setSubmitting }) => {
        ...
        try {
            ...
            const responseRequest = await fetch(
                "http://localhost:3000/participant/resetPasswordRequest",
                {
                    method: "POST",
                    headers: {
    ...
    const handlePasswordSubmit = async (values, { setSubmitting }) => {
        ...
        try {
            ...
            const responseResetPassword = await fetch(
                "http://localhost:3000/participant/resetPassword",
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
